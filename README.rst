...
The default language for this Project is **English**, and we use internatinalization to translate the text into Serbian.
...
Go to the terminal, inside the taskbuster_project folder and create the files to translate with::
    ...
    $ python manage.py makemessages -l rs
 
change the language "rs" for your selected language.
...
Once the translation is done, compile your messages with::
    ...
    $ python manage.py compilemessages -l rs
